...
function dailybird() {
    ...
    var indx = Math.floor( (x - Math.floor(x)) * 4823);
    return names[indx];
}
todaysbird = dailybird()

document.write(todaysbird)

var xhr = new XMLHttpRequest();

var url = "https://en.wikipedia.org/w/api.php?action=query&format=json&titles=list_of_birds_by_common_name&prop=links&pllimit=max";
